...
public class ItemMultinarzedzie extends ElementsResourceGeneratorMod.ModElement {
	@GameRegistry.ObjectHolder("resource_generator:multinarzedzie")
	public static final Item block = null;
	public ItemMultinarzedzie(ElementsResourceGeneratorMod instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("multinarzedzie").setRegistryName("multinarzedzie").setCreativeTab(TabGenerators.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("resource_generator:multinarzedzie", "inventory"));
	}
