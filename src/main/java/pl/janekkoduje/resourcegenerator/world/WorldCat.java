...
package pl.janekkoduje.resourcegenerator.world;

import pl.janekkoduje.resourcegenerator.procedure.ProcedureCatPlayerEntersDimension;
import pl.janekkoduje.resourcegenerator.item.ItemCat;
...
public class WorldCat extends ElementsResourceGeneratorMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("resource_generator:cat_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldCat(ElementsResourceGeneratorMod instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemCat().setUnlocalizedName("cat").setRegistryName("cat"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension cat is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("cat", "_cat", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemCat.block, 0, new ModelResourceLocation("resource_generator:cat", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureCatPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.GLOWSTONE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("cat_portal");
			setRegistryName("cat_portal");
			setLightLevel(1F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.GLOWSTONE.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.GLOWSTONE.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.TNT.getDefaultState();
		private static final IBlockState STONE2 = Blocks.TNT.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("taiga")),
				Biome.REGISTRY.getObject(new ResourceLocation("frozen_ocean")), Biome.REGISTRY.getObject(new ResourceLocation("savanna")),
				Biome.REGISTRY.getObject(new ResourceLocation("resource_generator:mybiome")),};
