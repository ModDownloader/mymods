...
import pl.janekkoduje.resourcegenerator.procedures.DinoEntityDiesProcedure;
...
public class DinoEntity extends ResourceGeneratorModElements.ModElement {
	...
	public DinoEntity(ResourceGeneratorModElements instance) {
		super(instance, 50);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.4f, 0.7f)).build("dino")
						.setRegistryName("dino");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -10027264, -6724096, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dino_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new ChickenModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("resource_generator:textures/pobrany_plik.png");
			}
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("resource_generator:dino.living"));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("resource_generator:dino.death"));
		}
