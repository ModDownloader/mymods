...
public class BlockWoodSlab extends ElementsResourceGeneratorMod.ModElement {
	@GameRegistry.ObjectHolder("resource_generator:wood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("resource_generator:wood_slab_double")
	public static final Block block_slab_double = null;
	public BlockWoodSlab(ElementsResourceGeneratorMod instance) {
		super(instance, 57);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("resource_generator:wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("wood_slab");
