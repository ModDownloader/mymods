...
public class GuiXp extends ElementsResourceGeneratorMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiXp(ElementsResourceGeneratorMod instance) {
		super(instance, 21);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("xp rain menu", 54, 6, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 35, this.guiTop + 60, 100, 20, "XP rain!!!"));
		}
