...
public class XdEntity extends ResourceGeneratorModElements.ModElement {
	public static EntityType entity = null;
	public XdEntity(ResourceGeneratorModElements instance) {
		super(instance, 7);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(1f, 1f)).build("xd")
						.setRegistryName("xd");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(GeneratorsItemGroup.tab)).setRegistryName("xd_spawn_egg"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 100, 5, 5));
		}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 100;
			setNoAI(false);
			setCustomName(new StringTextComponent("jam jest kurczak"));
