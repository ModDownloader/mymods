...
public class WoodLeavesBlock extends ResourceGeneratorModElements.ModElement {
	@ObjectHolder("resource_generator:wood_leaves")
	public static final Block block = null;
	public WoodLeavesBlock(ResourceGeneratorModElements instance) {
		super(instance, 55);
	}
