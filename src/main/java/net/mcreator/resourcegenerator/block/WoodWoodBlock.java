...
public class WoodWoodBlock extends ResourceGeneratorModElements.ModElement {
	@ObjectHolder("resource_generator:wood_wood")
	public static final Block block = null;
	public WoodWoodBlock(ResourceGeneratorModElements instance) {
		super(instance, 52);
	}
