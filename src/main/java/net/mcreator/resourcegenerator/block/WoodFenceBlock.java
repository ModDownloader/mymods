...
public class WoodFenceBlock extends ResourceGeneratorModElements.ModElement {
	@ObjectHolder("resource_generator:wood_fence")
	public static final Block block = null;
	public WoodFenceBlock(ResourceGeneratorModElements instance) {
		super(instance, 58);
	}
