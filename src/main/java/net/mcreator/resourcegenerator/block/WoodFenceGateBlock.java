...
public class WoodFenceGateBlock extends ResourceGeneratorModElements.ModElement {
	@ObjectHolder("resource_generator:wood_fence_gate")
	public static final Block block = null;
	public WoodFenceGateBlock(ResourceGeneratorModElements instance) {
		super(instance, 59);
	}
