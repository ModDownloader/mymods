...
public class WoodLogBlock extends ResourceGeneratorModElements.ModElement {
	@ObjectHolder("resource_generator:wood_log")
	public static final Block block = null;
	public WoodLogBlock(ResourceGeneratorModElements instance) {
		super(instance, 53);
	}
